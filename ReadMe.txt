================================================================================
MICROSOFT FOUNDATION CLASS ライブラリ: FelicaReader プロジェクトの概要
===============================================================================

アプリケーション ウィザードが作成した FelicaReader には Microsoft 
Foundation Class の基本的な使い方が示されています。アプリケーション作成のひな型
としてお使いください。

このファイルには FelicaReader アプリケーションを構成している各ファイ
ルの概要説明が含まれます。

FelicaReader.vcxproj
...
FelicaReader.h
   ...
   CFelicaReaderApp アプリケーション クラスを宣言します。

FelicaReader.cpp
   これは、アプリケーション クラス CFelicaReaderApp を含むメイン アプリケー
   ション ソース ファイルです。
...
res\FelicaReader.ico
   これは、アプリケーションのアイコンとして使用されるアイコンファイルです。この
   アイコンはメイン リソース ファイル FelicaReader.rc に含まれていま
   す。

res\FelicaReader.rc2
...
FelicaReaderDlg.h, FelicaReaderDlg.cpp - ダイアログ
   これらのファイルは CFelicaReaderDlg クラスを含みます。このクラスはアプ
   リケーションのメイン ダイアログの動作を定義します。ダイアログ テンプレートは
   Microsoft Visual C++ で編集可能な FelicaReader.rc に含まれます。
...
StdAfx.h, StdAfx.cpp
   ...
   FelicaReader.pch や既にコンパイルされた型のファイル StdAfx.obj を
   ビルドするために使用されます。
