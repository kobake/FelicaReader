...
#define SAMPLE_TITLE		_T("READ BINARY/UPDATE BINARY (TypeA Mifare Standard)")
...
int main(int argc, _TCHAR* argv[])
{
	...
	SENDCOMM	SendComm[] = {
					{11, {0xFF, 0x82, 0x00, 0x00, 0x06,
						  0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF}},				/* Load Key Mifare Default Key(FFFFFFFFFFFF) */
					{10, {0xFF, 0x86, 0x00, 0x00, 0x05, 
					      0x01, 0x00, 0x04, 0x60, 0x00}},					/* General Authenticate block4 */
					{5,  {0xFF, 0xB0, 0x00, 0x04, 0x00}},					/* ReadBinary Block4 */
					{21, {0xFF, 0xD6, 0x00, 0x04, 0x10,
						  0x0F, 0x1E, 0x2D, 0x3C, 0x4B, 0x5A, 0x69, 0x78,
						  0x87, 0x96, 0xA5, 0xB4, 0xC3, 0xD2, 0xE1, 0xF0}},	/* UpdateBinary Block4 */
					{5,  {0xFF, 0xB0, 0x00, 0x04, 0x00}},					/* ReadBinary Block4 */
					{-1, NULL},
				};
