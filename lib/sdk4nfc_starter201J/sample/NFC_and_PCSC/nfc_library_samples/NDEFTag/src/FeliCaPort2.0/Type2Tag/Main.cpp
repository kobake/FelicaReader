...
#define COMMAND_NAME TEXT("Type2Tag")
...
void usage(void)
{
	...
	_tprintf_s(TEXT("  %s\n"), CMD_READ);
	_tprintf_s(TEXT("\t Read from the Type2 Tag.\n"));
	_tprintf_s(TEXT("  %s\n"), CMD_WRITE);
	_tprintf_s(TEXT("\t Write to the Type2 Tag.\n"));
	_tprintf_s(TEXT("\n"));
